 ...
 */
class Statement extends AbstractBase implements StatementInterface
{
    /** @var resource */
    protected $resource;
     ...
     * @throws \Oci8\Exception
     */
    public function __construct($resource)
    {
        if (!is_resource($resource) || get_resource_type($resource) !== 'oci8 statement') {
            throw new Exception('resource is not an oci8 statement', 0, E_ERROR, __FILE__, __LINE__);
        }
    ...
    public function getField($field)
    {
        ...
        $field = new Field($name, $value, $size, $precision, $scale, $type, $rawType);
        restore_error_handler();
